...
Public Class crMileMessenger
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebMessenger.crMileMessenger.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrMileMessenger
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crMileMessenger = New crMileMessenger()
        rpt.Site = Me.Site
        Return rpt
    End Function
